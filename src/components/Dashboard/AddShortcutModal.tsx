...
interface AddShortcutModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (original: string, replacement: string) => void;
}

export default function AddShortcutModal({ isOpen, onClose, onAdd }: AddShortcutModalProps) {
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-900">Add new shortcut</h2>
          <p className="text-gray-500 mb-6 text-sm leading-relaxed">
            Say your original phrase followed by the word "shortcut" to trigger the replacement.
          </p>
